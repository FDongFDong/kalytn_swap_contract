...
library PODLibrary {
    ...
    function getReserves(
        ...
        (uint256 reserve0, uint256 reserve1, ) = IPODPair(
    ...
    function quote(
        ...
        require(amountIn > 0, 'PODLibrary: INSUFFICIENT_AMOUNT');
        require(reserveIn > 0 && reserveOut > 0, 'PODLibrary: INSUFFICIENT_LIQUIDITY');
    ...
    */
    ...
    function getAmountOut(
        ...
        require(amountIn > 0, 'PODLibrary: INSUFFICIENT_INPUT_AMOUNT');
        require(reserveIn > 0 && reserveOut > 0, 'PODLibrary: INSUFFICIENT_LIQUIDITY');
    ...
    function getAmountsOut(
        ...
        require(path.length >= 2, 'PODLibrary: INVALID_PATH');
    ...
    function getAmountIn(
        ...
        require(amountOut > 0, 'PODLibrary: INSUFFICIENT_OUTPUT_AMOUNT');
        require(reserveIn > 0 && reserveOut > 0, 'PODLibrary: INSUFFICIENT_LIQUIDITY');
